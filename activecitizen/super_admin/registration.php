...
?>
	<div class="container" id="form_style">
  		<form role="form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST"> <!-- role="form" helps improve accessibility for people using screen readers -->
	    	...
	    	<div class="form-group">
	      		<label class="control-label" for="organization_id">Organization ID:</label>
	        	<input type="number" class="form-control" name="org_id" placeholder="Enter Organization ID" value="<?php echo $org_id; ?>">
	        	<span class="error"><?php if($org_id_error!=""){echo $org_id_error;} ?></span>
	    	</div>
