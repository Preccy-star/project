    ...
    if(isset($_POST["sdate"])){
      ...
      if(isset($_POST["exceededExpectation"])){
  		...
  		if(isset($_POST["comments"])){
  	 	...
  	 	$query = "INSERT INTO gh_wc_questionnaire_replys (sdate, gender, region, age, expectation, services, satisfaction,delivery, communication, corruption, information, understanding, accessibility, lowExpectation, exceededExpectation, comments) VALUES ('$Sdate', '$Gender', '$Region', '$Age', '$Expectation', '$Services', '$Satisfaction', '$Delivery', '$Communication', '$Corruption', '$Information', '$Understanding', '$Accessibility', '$Low_Expectation', '$Exceeded_Expectation', '$Comments')";
