  ...
  if(isset($_POST["submit"])){
    ...
    if($err_status == "off"){
      ...
      if(mysqli_num_rows($result) > 0){
        ...
        $_SESSION["organization"] = $row["organization"];  //for admin survey page
	...
	<div class="container form-container" id="form-body1">
        ...
        <span class="error"><?php if($login_error!=""){echo $login_error;} ?></span>
            ...
            <span class="error"><?php if($email_error!=""){echo $email_error;} ?></span>
        		<input type="email" class="form-control" name="email" placeholder="Enter Email Address" value="<?php echo $email; ?>"> <!-- class="form-control" gives tags like <input>, <textarea>, and <select> a width of 100%. -->
    		  </div>
